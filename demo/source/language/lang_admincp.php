...
(
	...
	'nav_group' => '公会',
	'nav_postsplit' => '帖子分表',
	'nav_group_setting' => '公会设置',
	'nav_group_type' => '公会分类',
	'nav_group_manage' => '公会管理',
	'nav_group_userperm' => '会长权限',
	'nav_group_level' => '公会等级',
	'nav_group_mod' => '审核公会',
	'nav_group_level_editor' => '公会等级 -- 编辑',
	'nav_home' => '家园',
	...
	'nav_maint_threads_group' => '公会主题管理',
	'nav_recyclebin' => '主题回收站',
	'nav_recyclebinpost' => '回帖回收站',
	'nav_prune' => '论坛批量删帖',
	'nav_prune_group' => '公会批量删帖',
	'nav_doing' => '记录管理',
	'nav_blog' => '日志管理',
	'nav_feed' => '动态管理',
	'nav_album' => '相册管理',
	...
	'setting_domain_base_tips' => "<li>保留二级域名设置后所有人都无法申请或使用该域名</li><li>个人空间、公会的二级域名开启后需要到<strong>根域名设置</strong>中设置<strong>{$_G[setting][navs][3][navname]}、{$_G[setting][navs][4][navname]}</strong>的根域名</li>",
	...
	'setting_domain_allow_group' => '开启公会二级域名',
...
',
	...
	'setting_seo_group' => '公会首页/分类',
	'setting_seo_group_tips' => '<li>站点名称&nbsp;<font class="highlight">{bbname}</font>（应用范围：所有位置）</li><li>当前公会名称&nbsp;<font class="highlight">{forum}</font>（应用范围：除公会首页、分类页）</li><li>一级分类名称&nbsp;<font class="highlight">{first}</font>（应用范围：所有位置）</li><li>二级分类名称&nbsp;<font class="highlight">{second}</font>（应用范围：所有位置）</li><li>当前公会简介&nbsp;<font class="highlight">{gdes}</font>（应用范围：公会和公会帖子页）</li><li>帖子标题&nbsp;<font class="highlight">{subject}</font>（应用范围：公会帖子页）</li><li>主题摘要&nbsp;<font class="highlight">{summary}</font>（应用范围：公会帖子页）</li><li>主题标签&nbsp;<font class="highlight">{tags}</font>（应用范围：公会帖子内容页）</li><li>分页数&nbsp;<font class="highlight">{page}</font>（应用范围：主题列表页、帖子内容页）</li>',
	'setting_seo_grouppage' => '单一公会页面',
	'setting_seo_viewthread_group' => '公会帖子内容',
	...
	'setting_seo_code_group_forum' => '当前公会名称',
	'setting_seo_code_group_first' => '一级分类名称',
	'setting_seo_code_group_second' => '二级分类名称',
	'setting_seo_code_grouppage_forum' => '当前公会名称',
	'setting_seo_code_grouppage_first' => '一级分类名称',
	'setting_seo_code_grouppage_second' => '二级分类名称',
	'setting_seo_code_grouppage_gdes' => '当前公会简介',
	'setting_seo_code_grouppage_page' => '公会主题列表分页数',
	'setting_seo_code_viewthread_group_forum' => '当前公会名称',
	'setting_seo_code_viewthread_group_first' => '一级分类名称',
	'setting_seo_code_viewthread_group_second' => '二级分类名称',
	'setting_seo_code_viewthread_group_gdes' => '当前公会简介',
	...
	'setting_seo_rewritestatus_group_group' => '公会主题列表页',
	...
	'setting_functions_curscript_scriptclosed_group' => '是否开启公会功能',
	'setting_functions_curscript_scriptclosed_group_comment' => '关闭公会后，公会相关的所有功能将不能使用',
	...
	'setting_functions_curscript_group' => '公会',
	...
	'setting_permissions_allowviewuserthread_forum_group' => '所有版块和公会',
	...
	'setting_search_status_group' => '搜索公会',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'setting_ranklist_ignorefid' => '不参与排行的版块/公会',
	'setting_ranklist_ignorefid_comment' => '填入版块ID或公会ID，对应版块及下面的主题将不进入排行榜，多个版块ID间请用半角逗号 "," 隔开',
	...
	'forums_edit_extend_relatedgroup' => '关联公会/版块',
	'forums_edit_extend_relatedgroup_comment' => '填写被关联公会/版块的fid，以半角逗号 "," 隔开。版块的主题列表页将显示被关联公会/版块的主题',
	...
	'members_search_group_fid' => '公会 ID(多个公会逗号分隔)',
	...
	'founder_perm_group_editgroup' => '编辑公会',
	'founder_perm_group_deletegroup' => '删除公会',
	'founder_perm_group_deletegroupcomments' => '被选中公会所有数据将被删除',
	...
	'usergroups_edit_group' => '公会相关',
	'usergroups_edit_group_build' => '允许建立公会的数量',
	'usergroups_edit_group_build_comment' => '范围1-255，0为不允许建立公会',
	...
	'groups_search_result' => '共搜索到<strong> {groupnum} </strong>个符合条件的公会',
	'groups_setting_basic' => '基本设置',
	'groups_setting_basic_status' => '是否开启公会功能',
	'groups_setting_basic_mod' => '审核新公会',
	'groups_setting_basic_mod_comment' => '管理员建立公会时不需要审核',
	'groups_setting_basic_iconsize' => '公会图标文件大小(单位：KB)',
	'groups_setting_basic_iconsize_comment' => '设置公会图标文件的最大尺寸，0 或留空为不限制',
	'groups_setting_basic_recommend' => '推荐公会',
	'groups_setting_basic_recommend_comment' => '填写要推荐到公会首页的公会 ID，以半角逗号 "," 隔开，最多显示 8 个，如不足8个会自动补充积分最高的公会。例：“23,56,983”',
	'groups_setting_admingroup' => '选择管理用户组(在公会中具有与论坛中相对应的管理权限)',
	...
	'groups_type_count' => '公会数',
	'groups_type_operation' => '操作',
	'groups_type_show_rows' => '公会横排：',
	'groups_type_delete' => '删除本分类及分类下所有公会',
	'groups_type_search' => '搜索公会',
	'groups_manage_name' => '公会名称',
	'groups_manage_id' => '公会 ID',
	...
	'groups_editgroup_name' => '公会名',
	'groups_editgroup_category' => '公会分类',
	'group_mergetype' => '合并分类',
	'group_mergegroup' => '合并到公会',
	'group_changetype' => '转移到分类:',
	'group_mergetype_selecttype' => '选择目标分类',
	'group_mergetype_selecttype_comment' => '合并操作将把原分类下的所有公会转移到目标分类下，并删除原分类',
	'groups_editgroup_jointype' => '加入方式',
	'groups_editgroup_recommend' => '推荐公会',
	'groups_editgroup_visible_all' => '所有人可见',
	'groups_editgroup_description' => '简介',
	'groups_editgroup_rules' => '公告',
	'groups_editgroup_icon' => '公会图标',
	'groups_editgroup_banner' => '顶部图片',
	'groups_mergegroup_id' => '请填写目标公会ID',
	'group_mod_wait' => '待审核的公会',
	'group_mod_description' => '简介',
	'group_mod_delconfirm' => '确认要删除选中的公会吗？',
	...
	'threads_forumstick' => '版块/公会置顶',
	'threads_forumstick_tips' => '<li>多版块置顶功能可让一个主题在任意多个版块或公会分类内置顶显示。</li><li>管理员只需指定主题帖的 URL 地址，并选择要在哪些版块或公会分类中置顶该主题即可。</li>',
	...
	'threads_forumstick_targets_change' => '更改目标版块/公会分类',
	'threads_forumstick_targetgroups' => '选择目标公会分类',
	'threads_forumstick_targetgroups_comment' => '指定的主题会在这些公会分类的群中置顶显示，可以按住 CTRL 多选',
	'threads_forumstick_forum' => '论坛版块',
	'threads_forumstick_group' => '公会分类',
	...
	'misc_relatedlink_extent_group' => '公会主题',
...
<li><b>由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。</b></li><li>您可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置您的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。</li><li>除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。</li><li>您使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。</li><li>财付通服务热线：0755-83762288-2(全天24小时服务热线)</li>',
	...
	'project_option_group_allowbuildgroup' => '是否允许建立公会',
	...
	'project_option_group_allowgroupdirectpost' => '是否允许直接在公会中发帖',
	'project_option_group_allowgroupposturl' => '是否允许在公会中发站外URL',
	...
	'counter_groupmember_num' => '重建公会成员数',
	'counter_groupmember_post' => '重建公会成员发帖数',
	'counter_groupnum' => '重建分类公会数',
	...
	'group_level_add' => '增加公会等级',
	'group_level_tips' => '<li>公会等级不宜设置过多。</li><li>当允许公会内发帖等操作影响用户积分时应谨慎，用户有可能通过公会刷积分。</li><li>默认等级图标大小是25 X 25像素。</li>',
	...
	'group_level_special_allowchangename' => '允许创始人改公会名',
	'group_level_special_allowchangetype' => '允许创始人更改公会分类',
	'group_level_special_allowclose' => '允许创始人关闭公会',
	'group_level_special_allowthreadtype' => '允许设置主题分类',
	'group_level_special_membermax' => '公会最大成员数',

	'group_userperm_moderator' => '会长',
	'group_userperm_upload_banner' => '上传公会顶部图片',
	...
	'connect_setting_feed_group' => '公会是否允许推送',
	'connect_setting_feed_group_comment' => '设置在公会发表的主题是否可以推送到QQ空间动态',
	...
	'connect_setting_t_group' => '公会是否允许推送',
	'connect_setting_t_group_comment' => '设置在公会发表的主题是否可以推送到腾讯微博',
