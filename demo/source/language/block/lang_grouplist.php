...
$lang = array
(
	'grouplist_gtids' => '公会类别',
	'grouplist_gtids_comment' => '选择公会类别',
	'grouplist_fids' => '指定公会',
	'grouplist_fids_comment' => '输入指定公会的ID，多个ID之间用逗号分隔',
	'grouplist_startrow' => '起始数据行数',
	'grouplist_startrow_comment' => '如需设定起始的数据行数，请输入具体数值，0 为从第一行开始，以此类推',
	'grouplist_titlelength' => '名称长度',
	'grouplist_titlelength' => '设置公会名称最大长度',
	'grouplist_summarylength' => '介绍长度',
	'grouplist_summarylength_comment' => '设置公会介绍最大长度',
	'grouplist_orderby' => '公会排序方式',
	'grouplist_orderby_comment' => '设置以哪一字段或方式对公会进行排序',
