...
$lang = array (
  ...
  'group_nonexist' => '公会不存在',
  'grouptype_delete_sub_notnull' => '存在下级分类，请先返回删除本分类或分类的下级公会',
  ...
  'counter_groupmember_num_succeed' => '公会成员数重建完成',
  'counter_groupmember_post_succeed' => '公会成员发帖数重建完成',
  'counter_groupnum_succeed' => '分类公会数重建完成',
  ...
  'group_status_off' => '请先开启公会功能，现在转到公会设置页',
  'group_update_succeed' => '公会分类设置更新成功 ',
  'grouptype_delete_succeed' => '公会分类删除成功 ',
  'grouptype_delete_confirm' => '本操作不可恢复，您确定要删除该分类，清除其中帖子和附件吗？<br />注意：删除公会并不会更新用户发帖数和积分',
  'grouptype_delete_alarm' => '本操作不可恢复，正在删除公会数据...',
  'group_name_exist' => '该公会名称已经存在',
  'group_edit_succeed' => '公会编辑成功 ',
  'group_thread_removing' => '正在删除公会内的帖子，请勿关闭浏览器！',
  'group_delete_succeed' => '公会删除成功 ',
  'group_changetype_succeed' => '公会分类调整成功 ',
  'group_merge_continue' => '正在合并第{m}个公会，还有{n}个，请勿关闭浏览器！',
  'group_mergegroup_succeed' => '公会合并成功 ',
  'group_optype_no_choice' => '没有选择操作类型',
  'group_newtypeid_no_choice' => '没有选择公会分类',
  'group_targetgroup_no_choice' => '没有填写目标公会ID',
  'group_targetgroup_repeat' => '目标公会与被合并公会重复',
  'group_targetid_error' => '目标ID错误',
  'group_delete_confirm' => '删除公会操作不可恢复，确认要删除吗？',
  'group_changetype_confirm' => '确认要将所选公会移动到分类 <font class="highlight">[{targetname}]</font> 下吗？',
  'group_mergegroup_confirm' => '合并公会操作不可恢复，确认要合并到公会 <font class="highlight">[{targetname}]</font> 吗？',
  'group_group_no_choice' => '没有选择要操作的公会',
  'group_userperm_succeed' => '操作成功 ',
  'group_level_update_credits_invalid' => '缺少积分下限为负数或 0 的公会等级',
  'group_level_update_credits_duplicate' => '公会等级积分下限设置重复',
  'group_level_succeed_except_all_levels' => '操作失败，不允许删除除所有的公会等级',
  'group_level_update_succeed' => '公会等级更新成功。如您添加了新的等级，<br />请不要忘记修改其相应的设置',
  'group_level_noexist' => '公会等级不存在',
  'group_mergetype_confirm' => '合并公会操作不可恢复，确认要合并吗？',
  'group_mergetype_target_error' => '目标分类错误',
  'group_mergetype_succeed' => '分类合并成功 ',
  'group_mod_succeed' => '公会审核成功 ',
