...
$lang = array (
  ...
  'message_can_not_append_reason' => '抱歉，以下用户列表加入公会失败 {cannotappend}',
  ...
  'the_group_is_friend' => '该公会已经与贵公会建立友情关系',
  'friend_group_succeed' => '友情公会建立成功',
  'the_group_is_not_friend' => '该公会与贵公会建立友情关系',
  'unfriend_group_succeed' => '友情公会解除成功',
  'can_not_friend_self' => '不能与自己建立友情关系',
  'can_not_enemy_self' => '不能与自己建立敌对关系',
  'the_group_is_enemy' => '该公会已经与贵公会建立敌对关系',
  'enemy_group_succeed' => '敌对公会建立成功',
  'the_group_is_not_enemy' => '该公会与贵公会不是敌对关系',
  'nonenemy_group_succeed' => '敌对公会解除成功',
  'no_unfriend_self' => '公会与自身不存在友情关系',
  'no_nonenemy_self' => '公会与自身不存在敌对关系',
  ...
  'group_member_contribute_tcp_succeed' => '谢谢您为{_G/setting/navs/3/navname}公会捐献的TCP',
  'group_member_tcp_shortage' => '您的TCP不足',
  'group_member_contribute_tcp_need_natural_number' => '您捐献的TCP必须是自然数',
  'group_member_contribute_tcp_to_other' => '您不能为其他公会捐献TCP',
